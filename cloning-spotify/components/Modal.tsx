    ...
    <Dialog.Root open={isOpen} defaultOpen={isOpen} onOpenChange={onChange}>
      <Dialog.Portal>
        <Dialog.Overlay className="bg-neutral-900/90 background-blur-sm fixed inset-0">
          <Dialog.Content className="fixed drop-shadow-md border-netural-700 top-[50%] left-[50%] max-h-full h-full  max-w-full w-full md:h-auto md:max-h-[85vh] md:w-[90vw] md:max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-md bg-neutral-800 p-[25px] focus:outline-none">
